...
import com.thiagosalvess.admin.catalogy.domain.validation.Validator;
...
public class GenreValidator extends Validator {
    ...
    private void checkNameConstraints() {
        ...
        if (name == null) {
            this.validationHandler().append(new com.thiagosalvess.admin.catalogy.domain.validation.Error("'name' should not be null"));
            return;
        }

        if (name.isBlank()) {
            this.validationHandler().append(new com.thiagosalvess.admin.catalogy.domain.validation.Error("'name' should not be empty"));
            return;
        }
