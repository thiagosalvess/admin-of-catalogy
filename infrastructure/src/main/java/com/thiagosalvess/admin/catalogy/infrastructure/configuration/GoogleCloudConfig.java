...
import com.thiagosalvess.admin.catalogy.infrastructure.configuration.properties.google.GoogleCloudProperties;
...
public class GoogleCloudConfig {
    ...
    @Bean
    @ConfigurationProperties("google.cloud.storage.catalogy-videos")
